...
Dim G(), VGo() As Integer
Dim p, l, Depth, n, Suggest, F, v, w, Must, k, Boundry(), tV(), WP, Near(60) As Integer
Dim Force(0 To 30), Delay, GoUp, ex(0 To 64) As Boolean
Public ValueX As Integer
Private Sub Choose()
Static x, vv, v, Temp As Integer
...
Static x, y, z, v, Vmax, Vmin As Integer
Vmax = 0
Vmin = 100
For p = 1 To 64
