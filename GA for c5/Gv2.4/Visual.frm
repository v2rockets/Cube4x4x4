...
Begin VB.Form Visual 
   ...
   Begin VB.ComboBox Combo1 
      Height          =   405
      ItemData        =   "Visual.frx":0CCA
      Left            =   8400
      List            =   "Visual.frx":0CD4
...
MsgBox ("Game end due to a draw.")
Label1.Caption = "Draw no path"
  Else
  If Abs(ValueX) > 9000 Then
  u = (10000 - Abs(ValueX)) * Sgn(ValueX)
  Label2.Caption = "Value:#" & u
  Else
